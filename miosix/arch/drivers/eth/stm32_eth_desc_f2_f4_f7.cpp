...
void RxDmaDescriptor::syncToCpu() {
    miosix::markBufferAfterDmaRead(buffer, size & 0x1FFF);
    miosix::markBufferAfterDmaRead(this, sizeof(RxDmaDescriptor));
}

void RxDmaDescriptor::syncToDma() {
    miosix::markBufferBeforeDmaWrite(this, sizeof(RxDmaDescriptor));
}
...
void TxDmaDescriptor::syncToDma() {
    miosix::markBufferBeforeDmaWrite(buffer, size & 0x1FFF);
